...
fit_lasso_d_flex <- cv.glmnet(model_flex_D_train, d_train, family = "binomial", alpha = 1)
fit_ridge_d_flex <- cv.glmnet(model_flex_D_train, d_train, family = "binomial", alpha = 0)
fit_elnet_d_flex <- cv.glmnet(model_flex_D_train, d_train, family = "binomial", alpha = .5)
...
dhat_lasso_flex_train <- predict(fit_lasso_d_flex, newx = model_x_flex_train)
